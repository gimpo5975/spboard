...
<link
	href="https://fonts.googleapis.com/css2?family=Nanum+Myeongjo:wght@400;700;800&family=Noto+Sans+KR:wght@100;300;400;500;700;900&display=swap"
	rel="stylesheet">
...
<body>
	...
	<div class="container">
		<form class="row was-validated" action="updateok" name="wirte_form"
			method="post">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<label>비밀번호</label> <input type="password" name="upass"
